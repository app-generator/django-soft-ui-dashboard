...
**Django** project crafted on top of **[Soft UI Dashboard](https://app-generator.dev/product/soft-ui-dashboard/)**, 
An iconic `Bootstrap` Design from [Creative-Tim](https://app-generator.dev/agency/creative-tim/).
...
---
[Django Soft UI Dashboard](https://app-generator.dev/product/soft-ui-dashboard/django/) - **Django** Starter provided by [App Generator](https://app-generator.dev)
