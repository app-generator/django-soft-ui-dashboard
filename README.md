...
| Free Version                          | [PRO Version](https://appseed.us/product/soft-ui-dashboard-pro/django/)    | 🚀 Custom - $5,999         |  
| --------------------------------------| --------------------------------------| --------------------------------------|
...
| ------------------------------------  | ------------------------------------                                  | ------------------------------------|
| ✓ [LIVE Demo](https://django-soft-dash.onrender.com/)  | 🚀 [LIVE Demo](https://django-soft-dash-pro.onrender.com/) | 🛒 `Order`: **[$5,999](https://appseed.gumroad.com/l/rocket-package)** (GUMROAD) |   
